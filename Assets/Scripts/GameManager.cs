...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (sequenceFinished == true)
        {
            ...
            if (waitAfterSequenceCounter < 0)
            {
                ...
                // NOTIFICATION SOUND
                AkSoundEngine.PostEvent(gameObjects[activeSequence[positionInSequence]].GetComponentInChildren<WwisePositionSetup>().notificationEvent, gameObjects[activeSequence[positionInSequence]].transform.GetChild(0).gameObject);
    ...
    public void PlayWrongSound(int whichButton)
    {
        ...
        if (gameActive && gameObjects[whichButton])
        {
            ...
            AkSoundEngine.PostEvent(go.GetComponentInChildren<WwisePositionSetup>().incorrectEvent, go.transform.GetChild(0).gameObject);
        }
    }
    ...
    public void PlayCorrectSound(int whichButton)
    {
        ...
        {
            GameObject go = gameObjects[whichButton];
            AkSoundEngine.PostEvent(go.GetComponentInChildren<WwisePositionSetup>().correctEvent, go.transform.GetChild(0).gameObject);
        }
    }
